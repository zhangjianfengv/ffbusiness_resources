<template>
  <form id="queryForm">
    <div class="input-group" id="queryParam">
      <input class="form-control" id="itemId" placeholder="请输入完整物品ID" type="text" value="">
      <input class="form-control" id="itemName" placeholder="请输入部分或完整物品名" type="text" value="">
      <input class="form-control" id="buyerName" placeholder="请输入完整购买者角色名" type="text" value="">
      <input class="form-control" id="date" placeholder="请选择或输入日期" type="text">
      ...
      <button class="btn btn-primary mx-1" onclick="searchItem()" type="button">搜索</button>
      <button class="btn btn-primary" onclick="searchMarketable()" type="button">
        畅销排行
      </button>
      <button class="btn btn-primary mx-1" onclick="openSearchItem()" type="button">
        物品查询
      </button>
      <button class="btn btn-primary" onclick="resetQueryParams()" type="button">重置</button>
    </div>
  </form>
  <div id="app">
  ...
  <div style="text-align:center;">
    <a href="http://www.beian.gov.cn/portal/registerSystemInfo"
       ...
       target="_blank"><img src="/beian.png" style="width: 12px;height: 12px"/>
