...
<head lang="en">
  ...
  <link href="/bootstrap-table-jumpto.css" rel="stylesheet">
...
<body>
<div>
  <form id="marketableForm">
    <div class="input-group" id="marketableParam">
      <select class="form-control" id="worldName">
      ...
      <select class="selectpicker" id="itemType" multiple title="选择物品类别">
      </select>
      <input class="form-control" id="min" min="0" placeholder="低价" type="number" value="">
      <input class="form-control" id="max" placeholder="高价" type="number" value="">
      <button class="btn btn-primary mx-1" onclick="filterMarketable()" type="button">查询</button>
      <button class="btn btn-primary mx-1" onclick="resetMarketable()" type="button">重置</button>
      <input class="form-control" id="search" placeholder="模糊过滤" type="text" value="">
      <select class="form-control mx-1" id="sortType">
        <option selected value="1">按交易次数排序</option>
        <option value="2">按售出总数排序</option>
      </select>
      <button class="btn btn-primary" onclick="openUpdateTimeTable()" type="button">统计更新情况</button>
    </div>
  </form>
...
<script src="/bootstrap-table-jumpto.js"></script>
<script src="/bootstrap-select.min.js"></script>
<script src="/base64.js"></script>
<script src="/itemType.js"></script>
<script src="/marketable.js"></script>
</body>
</html>