<template>
  <b-card-group deck v-if="show">
    <b-card header-tag="header" footer-tag="footer">
      ...
      <template #footer>
        <b-button href="#" @click="cancelCollect" :class="{ 'dark-theme': isDark }" type="button">取消收藏</b-button>
      </template>
    </b-card>
    ...
    <b-card header-tag="header" footer-tag="footer">
      ...
      <template #footer>
        <b-button @click="cancelCollect" href="#" :class="{ 'dark-theme': isDark }" type="button">取消收藏</b-button>
      </template>
    </b-card>
  </b-card-group>
</template>
