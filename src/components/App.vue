    ...
    <div>
      <b-navbar toggleable="sm" type="dark" variant="info">
        ...
        <b-collapse id="nav-collapse" is-nav>
          <b-navbar-nav>
            <b-nav-item to="/history" exact-path exact-active-class="active">水晶转移记录</b-nav-item>
            <b-nav-item to="/marketable" exact-path exact-active-class="active">晶簇记录</b-nav-item>
            <b-nav-item to="/item" exact-path exact-active-class="active">水晶查询</b-nav-item>
            <b-nav-item to="/my" exact-path exact-active-class="active">我的关注</b-nav-item>
            <b-nav-item to="/current" exact-path exact-active-class="active">正在转移</b-nav-item>
