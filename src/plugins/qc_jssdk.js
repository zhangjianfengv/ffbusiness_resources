var QC = function () {
    ...
    var a = window.ActiveXObject && ~~navigator.userAgent.match(/MSIE\s+(\d+)/)[1], t = (e._reg = /\{(\w+)\}/g, {
        str2dom: function (t) {
            var n = [], e = arguments.callee._temp = arguments.callee._temp || document.createElement("div");
    ...
    var r, s,
        n = (r = /[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g, s = {
            ...
            stringify: window.JSON && JSON.stringify ? JSON.stringify : c, parse: function (e) {
                e = e || "{}";
                var t = {};
                try {
    ...
    var d, i, p, u, l, h, f, m = function () {
            ...
            return {
                stringify: function (t) {
                    ...
                    try {
                        ...
                        var i = (new DOMParser).parseFromString(t, "text/xml"), r = e.importNode(i.documentElement, !0);
            ...
            extend: function () {
                var t, e, n, o = arguments, i = arguments.length, r = !1, a = 1, s = o[0];
                for ("boolean" == typeof s && (r = s, s = arguments[1] || {}, a = 2), "object" != typeof s && "function" != typeof s && (s = {}), i === a && (s = {}, --a); a < i; a++) if (null != (t = arguments[a])) for (var c in t) e = s[c], s !== (n = t[c]) && (r && n && "object" == typeof n && !n.nodeType ? (e = e || (n instanceof Array ? [] : "object" == typeof n ? {} : n), s[c] = object.extend(r, e, n)) : void 0 !== n && (s[c] = n));
                return s
            }
        }, _ = (d = /"/g, i = {
            genHttpParamString: function (t) {
                ...
                if ("string" != typeof n && (n = ""), "string" != typeof o && (o = "="), (r = t.split(e = "string" != typeof e ? "&" : e)) && r.length) for (var d = 0, p = r.length; d < p; ++d) 1 < (a = r[d].split(o)).length ? (s = (s = a.slice(1).join(o).split(n)).slice(n.length, s.length - n.length).join(n), c[a[0]] = "function" == typeof i ? i(s) : s) : a[0] && (c[a[0]] = !0);
                return c
        ...
        y = (p = [/&(?!amp;|lt;|gt;|#039;|quot;|#39;)/g, /</g, />/g, /\x27/g, /\x22/g], u = ["&amp;", "&lt;", "&gt;", "&#039;", "&quot;"], {
            escHTML: function (t) {
        ...
        }), w = (f = (h = {log: 3, info: 2, warn: 1, error: 0}).info, {
            log: C("log"),
            info: C("info"),
            warn: C("warn"),
            error: C("error"),
    ...
    var q,
        q = (k.list = [], k.fired = !1, q || (q = !0, document.addEventListener ? document.addEventListener("DOMContentLoaded", function () {
...
!function (g) {
    ...
    for (var i, r = /qc_jssdk/i, a = document.getElementsByTagName("script"), s = 0, c = a.length; s < c; s++) if (((i = a[s]).src || "").match(r)) {
        e = i;
        break
    }
    var y = g.Toolkit, v = g.JSON, w = (g.XML, g.Object), C = (g.QueryString, g.String, g.Cookie), q = g.Console,
        k = function () {
        }, x = window.ActiveXObject && ~~navigator.userAgent.match(/MSIE\s+(\d+)/)[1], d = {
    ...
    g.Object.extend(h.prototype, {
        send: function () {
            var t = this.xhr, e = this.method, n = this.fmt, o = this, i = g.QueryString.stringify(o.paras),
    ...
    f.prototype.init = k, f.prototype.ready = function (t) {
        ...
        for (var i = f.pendingRequests, r = 0; r < i.length; r++) if (i[r].seq == t) return QC.Console.log("seq no :" + t + "响应收到  ts -> " + +new Date), i[r]._onCallback({
            status: n,
            responseText: e
    ...
    g.Object.extend(I.prototype, {
        prefix: "_TC_QC_flaProxy_", init: function () {
            ...
            i.style.cssText = "position:fixed; _position:absolute; top:-999px; left: -999px; width:1px; height:1px; margin:0; padding:0; display:none;", i.innerHTML = n, QC.Event.domReady(function () {
                ...
                var n = arguments;
                setTimeout(function () {
                    var t = f.getFunction(n[0]), e = n[1];
                    -1 < n[0].indexOf(".") ? t.apply(null, e) : t(e)
                })
            }
        }, _doSend: function (t) {
            var e = t.uri, n = g.QueryString.stringify(t.paras), o = t.seq, i = t.fmt, r = t.method,
            ...
            var o = t.currentTarget.data, t = "complete" != t.type ? 404 : 200;
        ...
        var o, i = [], r = [], a = !!window.ActiveXObject;
    ...
    var L = "https://graph.qq.com", S = g.Toolkit.extend(function () {
        f.apply(this, arguments)
    }, f);
    g.Object.extend(S.prototype, {
        init: function () {
            ...
            var e = t.data.split(":<.<<#:"), n = e[0], o = e[1], t = e[2], e = e[3];
    ...
    function j(e, t, n, o) {
        ...
        }, 10) : (T.push(r), g.Console.log((b.isReady && R < 0 ? "token获取失败，请调用用户登录流程" : "api代理尚未初始化成功") + "，调用请求入栈 : [" + e + "]，栈大小：" + T.length)), r.success(function () {
    ...
    g.Login = function () {
        ...
        function s(n) {
            ...
            var o = QC.getAppId();
            if (o < 0) QC.getAppId(arguments); else {
                n.size = n.size || "B_M";
                var t = _(n.btnId), e = (l[n.size] || l.B_M).styleId, i = n.fullWindow || !1, r = n.btnMode || "standard";
                n.redirectURI = n.redirectURI || O;
                var a, s, i = {size: e, fullWindow: i, url: arguments.callee._getPopupUrl(n)};
                if (n && n.btnId) {
        ...
        s.TEMPLATE = ['<a href="javascript:;" onclick="{onclick};"><img src="{src}" alt="{alt}" border="0"/></a>'].join(""), (s.getBtnHtml = function (t, e, n) {
            ...
            standard: function (t) {
                ...
                var n = v.stringify(e), e = (l[e.size] || l.B_M).size.split("*");
            ...
            var e = t.scope || "all", n = t.redirectURI || "", o = t.display || "", t = t.appId || QC.getAppId(),
        ...
        var c, o = function () {
            return p || function () {
                ...
                if ((e = C.get("__qc__k")) && (t = e.split("="), e.length && 2 != t.length)) throw new Error("QQConnect -> cookie : __qc__k 格式非法");
                p = n && n[1] || t && t[1]
            }()
        }, h = function () {
            var i, r = [];
        ...
        return w.extend(t, {
            insertButton: s, getMe: h, showPopup: function (t) {
                t = s._getPopupUrl(t || {});
    ...
    g.init = function (o) {
        F = o = o || F || {};
        var t = g.Login._getTokenKeys();
        if (R = o.appId, O = o.redirectURI, t.openid) g.Login.getMe(function (t, e, n) {
        ...
        }, !0); else if (f.invoke(), P.length && -1 < o.appId) for (var e = 0; e < P.length; e++) P[e]()
    }, g.getAppId = function (t) {
        return t && P.push(function () {
    ...
    A = "102075021", z = "https://www.ff14pvp.top/api/oauth/QQ/callback", A && (g.Console.info("检测到自动初始化参数\nappId:" + A + "\nrUri:" + z), isNaN(A) ? g.Console.error("参数appid错误") : z && 0 != z.indexOf("http") ? g.Console.error("参数rediectURI错误") : g.Event.domReady(function () {
        g.init({appId: A, redirectURI: z})
    })), t("callback") ? (window._b_is_qc_cb_win = !0, QC.Login.getMe(function (e, n, t) {
        if (window.opener) {
